...
我是 **Ryanwu**，南京邮电大学通信工程本科在读。

用一句话介绍自己：**我能把东西做出来，也能把它讲清楚、推着它落地。**

这两年我的精力主要落在三件事上：**把 AI 做成能用的东西**、**把一门课程从零卖进校园**、**把技术活动组织起来**。

其中 AI 这条线，我做的是两个场景——**互联网应用**和**工业现场**。一边是前后端、客户端这些直接面向用户的产品，另一边是中车实习里把视觉模型接到巡检机器人上。两边要解决的问题不一样，但都要回答同一句话：**做出来的东西，到底有没有人真的在用。**

它们底层其实是同一件事：**把模糊的目标拆成能交付的东西，然后推动它真的跑起来，而不是停在演示阶段。**
...
<div class="about-note">
  ...
  <div class="about-note-text">
    <p>2026 年 7 月，我进入中国中车数字科技做 AI Agent 开发实习，手上主要两块：<strong>电力设备巡检机器人的视觉算法</strong>，以及<strong>部门级 AI Agent 协作体系</strong>。</p>
    <p>这是我第一次完整参与「从现场需求到系统落地」的过程——不再是做完一个 Demo 就结束，而是要真的有人用、真的要能一直跑住。</p>
  </div>
</div>

我做的不只是模型本身——还包括**设计模型输出的字段契约**，让结果能被上位机消费、能给机械臂链路提供定位和位姿信息。这一步才是算法能不能真正进系统的分水岭：**下游系统没办法靠一段自然语言去猜下一步该做什么。**

这条线现在也在往前走。原来的方案本质上是「模型识别 + 规则判断 + 机械臂执行」——识别出温度、开关状态，再由机械臂去按按钮、点开关。**现在我们正在试另一条路**：用 VLN 做轨道定位，探索让巡检机器人具备更强的自主能力；同时尝试用纯视觉去替代现有的视觉算法模块。这两块都还在验证阶段，还没有替代已经在跑的旧方案，按目前的节奏预计 **2026 年底到 2027 年初**能做完。
...
<div class="about-note is-flipped">
  ...
  <div class="about-note-text">
    <p><strong>江苏大学生创新大赛</strong>（前身是大家更熟悉的「互联网+」）——2026 年我和队友组队参赛，做的是<strong>面向老年人的智能陪伴机器人</strong>这个方向，最后拿了<strong>省二等奖</strong>。照片是省赛现场拍的，同方向的发明专利也在下面这一节里。</p>
  </div>
</div>
...
**AI 与多模态**
- 机器学习基础：机器学习、深度学习、强化学习
- 微调与迁移学习：LoRA、Adapter、冻结主干与分层解冻、迁移学习
- 训练与优化：SGD / Momentum / Adam / AdamW、学习率调度、梯度裁剪、批大小与轮数调参
...
<div class="about-note">
  ...
  <div class="about-note-text">
    <p><strong>篮球</strong>是我打得最久的一件事，从高中一直打到现在。最痛快的一次不是大学的比赛，是<strong>高中那场联赛</strong>——我带着我们班一路打到全校男子组第一，最后发下来一个特别大的奖杯。照片就是夺冠那天在球馆里拍的。</p>
  </div>
</div>
...
<div class="about-note is-flipped">
  ...
  <div class="about-note-text">
    <p>到了大学我进了<strong>院队</strong>，位置是<strong>小前锋</strong>，主要负责得分和内线的对抗。大一打得最多，大二开始变少，现在大三基本一个月一次。</p>
    <p>这张是队里打完球在体育馆拍的合影，人比高中那次多了不少。</p>
  </div>
</div>
...
<div class="about-note is-large">
  ...
  <div class="about-note-text">
    ...
    <p>有个愿望：<strong>大四想上台打一次中国大学生自然组的健体比赛。</strong>我最崇拜的选手是何局，应该是中国健美健体的第一人，他的形体我特别喜欢。当然不指望练成那样，只希望自己有清晰的肌肉线条，练得好看一点。</p>
    <p>练到现在最大的感受是，这件事没法偷懒——练没练，身体自己知道。</p>
  </div>
</div>
...
<div class="about-note is-medium">
  <div class="about-note-img">
  ...
  <div class="about-note-text">
    ...
    <p>不用干什么，沿着湖走两圈，看看水面和远处的灯，人就能缓过来。有时候什么都不想，走完回宿舍，那点事也就没那么大了。</p>
  </div>
</div>
...
<div class="about-note is-flipped">
  ...
  <div class="about-note-text">
    ...
    <p>和玄武湖不一样——那边是安静，这边是人声鼎沸。热闹的街市、河上的灯影，走一圈心情就舒展开了。散步、发呆、把情绪放一放，对我来说是挺重要的一件事。</p>
    <p>这两个地方离学校都不远，想去就能去，算是我的固定出口。</p>
  </div>
</div>
...
<div class="about-note is-medium">
  ...
  <div class="about-note-text">
    ...
    <p>我喜欢路灯把树叶照亮的那种画面——安静，但是有人气。谈不上什么摄影，就是当时觉得好看，顺手拍下来了。</p>
  </div>
</div>
...
<div class="about-note is-large is-flipped">
  ...
  <div class="about-note-text">
    ...
    <p>这张是它钻垃圾桶的时候拍的——那天垃圾桶里套了塑料袋，我们把它放进去，它自己就把头探出来了。</p>
  </div>
</div>
...
<div class="about-note">
  ...
  <div class="about-note-text">
    ...
    <p>高中那帮人当时玩得特别好，毕业之后就各奔东西，去了不同的城市和学校。大学过得热闹，但偶尔还是会想起那段日子——把它放在这里，算是留个念想。</p>
  </div>
</div>
